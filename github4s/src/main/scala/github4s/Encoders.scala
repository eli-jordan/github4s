...
object Encoders {
  ...
  implicit val encoderNewDeployment: Encoder[NewDeploymentRequest] =
    deriveEncoder[NewDeploymentRequest]
  ...
  implicit val encodeCheckRunConclusion: Encoder[CheckRunConclusion] =
    Encoder[String].contramap(_.name)
  ...
  implicit val encoderCheckRunAnnotation: Encoder[CheckRunAnnotation] =
    deriveEncoder[CheckRunAnnotation]
