...
object Decoders {
  ...
  implicit val decoderCheckRunAnnotation: Decoder[CheckRunAnnotation] =
    deriveDecoder[CheckRunAnnotation]
  ...
  implicit val decoderCheckSuitePR: Decoder[CheckSuitePullRequest] =
    deriveDecoder[CheckSuitePullRequest]
  implicit val decoderCheckSuitePRBranch: Decoder[CheckSuitePullRequestBranch] =
    deriveDecoder[CheckSuitePullRequestBranch]
  implicit val decodeListCheckRunsResponse: Decoder[ListCheckRunsResponse] =
    deriveDecoder[ListCheckRunsResponse]
