...
object Decoders {
  ...
  implicit val decodeDeploymentStatusState: Decoder[DeploymentStatusState] =
    Decoder[String].emap(value =>
      DeploymentStatusState.fromString(value).toRight(s"$value not a member of DeploymentStatusState"))
  ...
  implicit val decoderCheckRunAnnotation: Decoder[CheckRunAnnotation] = deriveDecoder[CheckRunAnnotation]
  implicit val decoderCheckRunImage: Decoder[CheckRunImage]           = deriveDecoder[CheckRunImage]
  implicit val decoderCheckRunAction: Decoder[CheckRunAction]         = deriveDecoder[CheckRunAction]
  implicit val decoderCheckSuite: Decoder[CheckSuite]                 = deriveDecoder[CheckSuite]
  implicit val decoderCheckSuitePR: Decoder[CheckSuitePullRequest]    = deriveDecoder[CheckSuitePullRequest]
  implicit val decoderCheckSuitePRBranch: Decoder[CheckSuitePullRequestBranch] =
    deriveDecoder[CheckSuitePullRequestBranch]
  implicit val decodeListCheckRunsResponse: Decoder[ListCheckRunsResponse] = deriveDecoder[ListCheckRunsResponse]
